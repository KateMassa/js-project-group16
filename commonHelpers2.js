import{l as g,d as L}from"./assets/main-62766113.js";import{P}from"./assets/vendor-4563c95f.js";const I="/js-project-group16/assets/book-pile-c3b346c2.png",a=3;let i;function m(e,t){const o=(t-1)*a,r=o+a;return e.slice(o,r)}function u(e){const t=document.querySelector(".shopping-list");if(!t){console.error("Element with class 'shopping-list' not found.");return}e.length===0?t.classList.add("empty-page-content"):t.classList.remove("empty-page-content"),t.innerHTML="";const o=`<p class="shopping-list-empty-text">This page is empty, add some books and proceed to order.</p>
          <img
          class="no-book"
          src="${I}"
          alt="Book"

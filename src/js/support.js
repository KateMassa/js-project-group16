...
import saveTheChildren from '../img/save-the-children.png';
import projectHope from '../img/project-hope.png';
import internationalMedicalCorps from '../img/international-medical-corps.png';
import razom from '../img/razom.png';
import actionAgainstHunger from '../img/action-against-hunger.png';
import serhiyPrytulaCharityFoundation from '../img/prytula.png';
import united from '../img/united24.png';
import medecinsSansFrontieres from '../img/medecins-sans-frontieres.png';
import worldVision from '../img/world-vision.png';
import saveTheChildren2x from '../img/save-the-children-2x.png';
import projectHope2x from '../img/project-hope-2x.png';
import internationalMedicalCorps2x from '../img/international-medical-corps-2x.png';
import razom2x from '../img/razom-2x.png';
import actionAgainstHunger2x from '../img/action-against-hunger.png';
import serhiyPrytulaCharityFoundation2x from '../img/prytula-2x.png';
import united2x from '../img/united24-2x.png';
import medecinsSansFrontieres2x from '../img/medecins-sans-frontieres.png';
import worldVision2x from '../img/world-vision-2x.png';
